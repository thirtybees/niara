  ...
  <div id="idTab1" class="tab-pane active">
    ...
    {if $canSendInvitations}
      ...
      <form method="post" action="{$link->getModuleLink('referralprogram', 'program', [], true)|escape:'html':'UTF-8'}" class="std">
        ...
        <div class="submit">
          <button type="submit" id="submitSponsorFriends" name="submitSponsorFriends" class="btn btn-lg btn-success"><span>{l s='Validate' mod='referralprogram'} <i class="fas fa-chevron-right"></i></span></button>
        </div>
      </form>
    {else}
  ...
  <ul class="pager">
    <li class="previous">
      <a href="{$link->getPageLink('my-account', true)|escape:'html':'UTF-8'}">
        {if $isRtl}&rarr;{else}&larr;{/if} {l s='Back to your account' mod='referralprogram'}
      </a>
    </li>
  </ul>
</nav>
